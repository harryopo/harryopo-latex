...
\begin{kaobox}[frametitle=\noindent 待办]
	实现 \Option{justified} 和 \Option{margin} 选项。为了与 \KOMAScript 风格保持一致，它们应该接受一个简单开关作为参数，这个简单开关应该是 \Option{true} 或 \Option{false} ，或者是 \KOMAScript 支持的其他标准简单开关值之一。有关更多信息，请参阅 \KOMAScript 文档。
\end{kaobox}
