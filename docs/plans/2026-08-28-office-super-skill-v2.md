...
> **⚠️ 本方案已被 v3 取代（2026-08-30）**：阶段 3 因 web-editor 废弃而重定义（IDE 生态 + 轻量核对 + 修订审阅），并整合第三轮增量调研。请以 [2026-08-30-office-super-skill-v3.md](./2026-08-30-office-super-skill-v3.md) 为准。本文保留作历史决策记录。
